...
using System;
using System.Linq;
using BLEPMIS.Reports;

namespace BLEPMIS.Services
{
    public class CustomReportStorageFileWebExtension : ReportStorageWebExtension
    {
        readonly string ReportDirectory;
        const string FileExtension = ".repx";
        public CustomReportStorageFileWebExtension(IWebHostEnvironment env)
        {
            ReportDirectory = Path.Combine(env.ContentRootPath, "SavedReports");
