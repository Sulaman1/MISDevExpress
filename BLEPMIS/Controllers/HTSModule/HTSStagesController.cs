...
namespace CCView.Controllers.HTSModule
{
    public class HTSStagesController : Controller
    {
        ...
        public async Task<IActionResult> Create(HTSStage HTSStage, IFormFile StageAttachment, IFormFile Picture1, IFormFile Picture2)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, HTSStage HTSStage,IFormFile StageAttachment, IFormFile Picture1, IFormFile Picture2)
        {
