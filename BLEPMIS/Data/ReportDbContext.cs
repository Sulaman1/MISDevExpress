...
namespace BLEPMIS.Data {
    ...
    public class ReportDbContext : DbContext {
        ...
        public void InitializeDatabase() {
            ...
            var reportSqlDataConnectionName = "ReportingLive";
            if (!SqlDataConnections.Any(x => x.Name == reportSqlDataConnectionName))
            {
                var newData = new SqlDataConnectionDescription
                {
                    ...
                    ConnectionString = "XpoProvider=MSSqlServer; Server=154.26.132.117;Database=BLEPMISDb; Pooling=false; user id=sa;password=Blep@321;MultipleActiveResultSets=true; Connection Timeout=60;" // Max Pool Size=100;
                };
                SqlDataConnections.Add(newData);
            }
