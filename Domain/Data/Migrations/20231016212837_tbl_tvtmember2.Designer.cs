...
namespace DBContext.Data.Migrations
{
    ...
    [Migration("20231016212837_tbl_tvtmember2")]
    partial class tbl_tvtmember2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Domain.BSF.BSFPrivate", b =>
                {
                    ...
                    b.Property<string>("BusinessFieldExperience")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("CurrentRegistrationStatus")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("DateofRegistration")
                        .HasColumnType("datetime2");

                    b.Property<string>("DetailofEmploymentJobforProposedBusiness")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ExistingBusinessName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("NatureofExistingBusiness")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NumberofJobBeneficiaries")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OtherAttachment")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProposedBusinessDistrict")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProposedBusinessName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RegistrationWithGOP")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("StructureofProposedBusiness")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TotalApplicantInRupees")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TotalGrantInRupees")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Models.Domain.MasterSetup.TVTTrainedBy", b =>
                {
                    b.Property<int>("TVTTrainedById")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TVTTrainedById"), 1L, 1);

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("TVTTrainedById");

                    b.ToTable("TVTTrainedBy", "master");
                });
            ...
            modelBuilder.Entity("DAL.Models.Domain.ToolApp.ToolAppPost.ToolInfoBasicPost", b =>
                {
                    b.Property<int>("ToolInfoBasicPostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ToolInfoBasicPostId"), 1L, 1);
                    ...
                    b.HasKey("ToolInfoBasicPostId");

                    b.HasIndex("ToolId");

                    b.ToTable("ToolInfoBasicPost", "mobile");
                });

            modelBuilder.Entity("DAL.Models.Domain.ToolApp.ToolAppPost.ToolInfoDetailPost", b =>
                {
                    b.Property<int>("ToolInfoDetailPostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ToolInfoDetailPostId"), 1L, 1);
                    ...
                    b.HasKey("ToolInfoDetailPostId");

                    b.HasIndex("ToolControlInfoPostId");

                    b.ToTable("ToolInfoDetailPost", "mobile");
                });

            modelBuilder.Entity("DAL.Models.Domain.ToolApp.ToolAppPost.ToolModulePost", b =>
                {
                    b.Property<int>("ToolModulePostId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ToolModulePostId"), 1L, 1);
                    ...
                    b.HasKey("ToolModulePostId");

                    b.ToTable("ToolModulePost", "mobile");
                });
            ...
            modelBuilder.Entity("DAL.Models.Domain.Training.MemberTraining", b =>
                {
                    ...
                    b.Property<string>("MemberTrainingCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Models.Domain.Training.TVTTraining", b =>
                {
                    b.Property<int>("TVTTrainingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TVTTrainingId"), 1L, 1);
                    ...
                    b.HasKey("TVTTrainingId");

                    b.HasIndex("TrainingTypeId");

                    b.HasIndex("VillageId");

                    b.ToTable("TVTTraining", "training");
                });

            modelBuilder.Entity("DAL.Models.Domain.Training.TVTTrainingMember", b =>
                {
                    b.Property<int>("TVTTrainingMemberId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TVTTrainingMemberId"), 1L, 1);
                    ...
                    b.Property<string>("BeneficiaryMISCode")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("TVTTrainingMemberId");

                    b.HasIndex("MemberId");

                    b.HasIndex("TVTTrainingId");

                    b.ToTable("TVTTrainingMember", "training");
                });
            ...
            modelBuilder.Entity("DAL.Models.ViewModels.LipIDO", b =>
                {
                    b.Property<int>("LIPAssetTransferId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.Models.Domain.ToolApp.ToolAppPost.ToolInfoDetailPost", b =>
                {
                    b.HasOne("DAL.Models.Domain.ToolApp.ToolAppPost.ToolControlInfoPost", "ToolControlInfoPost")
                        .WithMany()
                        .HasForeignKey("ToolControlInfoPostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ToolControlInfoPost");
                });
            ...
            modelBuilder.Entity("DAL.Models.Domain.Training.TVTTrainingMember", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Domain.Training.TVTTraining", "TVTTraining")
                        .WithMany()
                        .HasForeignKey("TVTTrainingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Member");

                    b.Navigation("TVTTraining");
                });
